...
{
    public class CreateClassicProcessTest
    {
        public static ClassicProcessTest Parameterized(long id, long numberOfTests, double nominalValueUnit1,
            double lowerLimitUnit1, double upperLimitUnit1, DateTime timestamp, double average, MeaUnit controlledByUnitId,
            double lowerInterventionLimitUnit1, double lowerInterventionLimitUnit2, double lowerLimitUnit2, double nominalValueUnit2,
            double standardDeviation, double testValueMaximum, double testValueMinimum, MeaUnit unit1Id, MeaUnit unit2Id,
