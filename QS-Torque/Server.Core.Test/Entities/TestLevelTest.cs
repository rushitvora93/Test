            ...
            return new EqualityTestHelper<TestLevel>(
                ...
                new List<EqualityParameter<TestLevel>>()
                {
                    ...
                    new EqualityParameter<TestLevel>()
                    {
                        ...
                        CreateParameterValue = () => new Interval() { IntervalValue = 5, Type = IntervalType.EveryXDays },
                        CreateOtherParameterValue = () => new Interval() { IntervalValue = 9, Type = IntervalType.EveryXShifts},
                        ParameterName = nameof(TestLevel.TestInterval)
                    },
                    new EqualityParameter<TestLevel>()
                    {
                        SetParameter = (entity, value) => entity.SampleNumber = (int)value,
                        CreateParameterValue = () => 456,
                        CreateOtherParameterValue = () => 798,
                    ...
                    new EqualityParameter<TestLevel>()
                    {
                        ...
                        CreateOtherParameterValue = () => true,
