...
namespace FrameworksAndDrivers.UnQLite {
    /// <summary>
    ...
    public sealed class UnQLite {
        ...
        /// </summary>
        public static unsafe string Signature {
            get {
        ...
        /// </summary>
        public static unsafe string Ident {
            get {
        ...
        /// </summary>
        public static unsafe string Copyright {
            get {
        ...
        /// <returns></returns>
        public static unsafe string GetDataBaseErrorLog(IntPtr pDb) {
            sbyte* zbuf = null;
            int len = 0;
            UnsafeNativeMethods.unqlite_config(pDb, UnQLiteConfigCode.ErrLog, __arglist(ref zbuf, ref len));
            if (len > 0) {
