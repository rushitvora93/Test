...
namespace Core.Test.Entities
{
    class StatusTest
    {
        ...
        {
            var left = new Status() { ListId = new HelperTableEntityId(97486153) };
            var right = new Status() { ListId = new HelperTableEntityId(147896325) };
        ...
        {
            var left = new Status() { ListId = new HelperTableEntityId(97486153) };
            var right = new Status() { ListId = new HelperTableEntityId(97486153) };
        ...
        {
            var left = new Status() { ListId = new HelperTableEntityId(97486153), Value = new StatusDescription("ofiugvjcmkspif") };
            var right = new Status() { ListId = new HelperTableEntityId(147896325), Value = new StatusDescription("ofiugvjcmkspif") };
        ...
        {
            var left = new Status() { ListId = new HelperTableEntityId(97486153), Value = new StatusDescription("ofiugvjcmkspif") };
            var right = new Status() { ListId = new HelperTableEntityId(97486153), Value = new StatusDescription("e34r56tz7uikjhgfre") };
        ...
        {
            var left = new Status() { ListId = new HelperTableEntityId(97486153), Value = new StatusDescription("ofiugvjcmkspif") };
            var right = new Status() { ListId = new HelperTableEntityId(97486153), Value = new StatusDescription("ofiugvjcmkspif") };
        ...
        {
            var left = new Status() { ListId = new HelperTableEntityId(97486153), Value = new StatusDescription("ofiugvjcmkspif") };
            var right = new Status() { ListId = new HelperTableEntityId(123654789), Value = new StatusDescription("asdfghjklöä") };
        ...
        {
            var entity = new Status() { ListId = new HelperTableEntityId(97486153), Value = new StatusDescription("ofiugvjcmkspif") };
