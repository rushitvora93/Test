...
namespace Core.Test.Entities
{
    class SwitchOffTest
    {
        ...
        {
            var left = new SwitchOff() { ListId = new HelperTableEntityId(97486153) };
            var right = new SwitchOff() { ListId = new HelperTableEntityId(147896325) };
        ...
        {
            var left = new SwitchOff() { ListId = new HelperTableEntityId(97486153) };
            var right = new SwitchOff() { ListId = new HelperTableEntityId(97486153) };
        ...
        {
            var left = new SwitchOff() { ListId = new HelperTableEntityId(97486153), Value = new HelperTableDescription("ofiugvjcmkspif") };
            var right = new SwitchOff() { ListId = new HelperTableEntityId(147896325), Value = new HelperTableDescription("ofiugvjcmkspif") };
        ...
        {
            var left = new SwitchOff() { ListId = new HelperTableEntityId(97486153), Value = new HelperTableDescription("ofiugvjcmkspif") };
            var right = new SwitchOff() { ListId = new HelperTableEntityId(97486153), Value = new HelperTableDescription("e34r56tz7uikjhgfre") };
        ...
        {
            var left = new SwitchOff() { ListId = new HelperTableEntityId(97486153), Value = new HelperTableDescription("ofiugvjcmkspif") };
            var right = new SwitchOff() { ListId = new HelperTableEntityId(97486153), Value = new HelperTableDescription("ofiugvjcmkspif") };
        ...
        {
            var left = new SwitchOff() { ListId = new HelperTableEntityId(97486153), Value = new HelperTableDescription("ofiugvjcmkspif") };
            var right = new SwitchOff() { ListId = new HelperTableEntityId(123654789), Value = new HelperTableDescription("asdfghjklöä") };
        ...
        {
            var entity = new SwitchOff() { ListId = new HelperTableEntityId(97486153), Value = new HelperTableDescription("ofiugvjcmkspif") };
