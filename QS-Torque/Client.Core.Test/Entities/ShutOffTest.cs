...
namespace Core.Test.Entities
{
    class ShutOffTest
    {
        ...
        {
            var left = new ShutOff() { ListId = new HelperTableEntityId(97486153) };
            var right = new ShutOff() { ListId = new HelperTableEntityId(147896325) };
        ...
        {
            var left = new ShutOff() { ListId = new HelperTableEntityId(97486153) };
            var right = new ShutOff() { ListId = new HelperTableEntityId(97486153) };
        ...
        {
            var left = new ShutOff() { ListId = new HelperTableEntityId(97486153), Value = new HelperTableDescription("ofiugvjcmkspif") };
            var right = new ShutOff() { ListId = new HelperTableEntityId(147896325), Value = new HelperTableDescription("ofiugvjcmkspif") };
        ...
        {
            var left = new ShutOff() { ListId = new HelperTableEntityId(97486153), Value = new HelperTableDescription("ofiugvjcmkspif") };
            var right = new ShutOff() { ListId = new HelperTableEntityId(97486153), Value = new HelperTableDescription("e34r56tz7uikjhgfre") };
        ...
        {
            var left = new ShutOff() { ListId = new HelperTableEntityId(97486153), Value = new HelperTableDescription("ofiugvjcmkspif") };
            var right = new ShutOff() { ListId = new HelperTableEntityId(97486153), Value = new HelperTableDescription("ofiugvjcmkspif") };
        ...
        {
            var left = new ShutOff() { ListId = new HelperTableEntityId(97486153), Value = new HelperTableDescription("ofiugvjcmkspif") };
            var right = new ShutOff() { ListId = new HelperTableEntityId(123654789), Value = new HelperTableDescription("asdfghjklöä") };
        ...
        {
            var entity = new ShutOff() { ListId = new HelperTableEntityId(97486153), Value = new HelperTableDescription("ofiugvjcmkspif") };
