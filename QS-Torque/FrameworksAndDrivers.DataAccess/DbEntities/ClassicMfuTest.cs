...
namespace FrameworksAndDrivers.DataAccess.DbEntities
{
    ...
    public class ClassicMfuTest
    {
        ...
        public long DISTRIBUTION_FORM { get; set; }
        ...
        public long NUMBER_OF_SPIKES { get; set; }
        public long USED_SPIKETESTS { get; set; }
        ...
        public double LIMIT_CM { get; set; }
        public double LIMIT_CMK { get; set; }
        ...
        public virtual ClassicMfuTestLocation ClassicMfuTestLocation { get; set; }
