...
serverpath="../QS-Torque/gRPC.Service\bin\Debug\net5.0/"
serverpathwindows=$(echo "$serverpath" | tr '/' '\\')
serverconfigtool="../../../../ServerConfigTool/bin/Debug/net5.0/ServerConfigTool.exe"
...
guitestrunnerconfig="../QS-Torque/V8_Oberflaechentests/UI_TestProjekt/appsettings.json"
configfileextension="*.config"
testsolutionpath="../QS-Torque/"
guitestsolutionpath="../QS-Torque/V8_Oberflaechentests/"
testsolution="IntegrationTests.sln"
guitestsolution="UI_TestProjekt.sln"
nugetpath="../"
nuget="nuget.exe"
...
git pull
cd ..
cp -R ../QS-Torque/gRPC.Service/bin bin/ 
if [ $? -ge 1 ]; then
...
setupandstartsqlitetest () {
  ...
  echo '{' > $guitestrunnerconfig
  echo '  "WindowsApplicationDriverUrl": "http://127.0.0.1:4723",' >> $guitestrunnerconfig
  echo '  "RelWinAppDriverPath": "\\..\\..\\..\\Windows Application Driver\\WinAppDriver.exe",' >> $guitestrunnerconfig
  echo '  "StartUpPath": "\\..\\..\\..\\..\\..\\StartUp\\bin\\Debug\\net5.0-windows10.0.19041.0\\StartUp.exe",' >> $guitestrunnerconfig
  echo '  "UnlockToolPath": "\\..\\..\\..\\..\\..\\..\\QS-Torque\\UnlockTool\\bin\\Debug\\net5.0-windows\\UnlockTool.exe",' >> $guitestrunnerconfig
  echo '  "WorkingDir": "\\..\\..\\..\\..\\..\\StartUp\\bin\\Debug\\net5.0-windows10.0.19041.0"' >> $guitestrunnerconfig
  echo '}' >> $guitestrunnerconfig

  ./$nugetpath$nuget restore $guitestsolutionpath$guitestsolution
  dotnet test $guitestsolutionpath$guitestsolution
  if [ $? -ge 1 ]; then
    writeerrorfile
...
export fqdn
export guitestsolutionpath
export guitestsolution
...
unset guitestsolution
unset guitestsolutionpath
unset fqdn
